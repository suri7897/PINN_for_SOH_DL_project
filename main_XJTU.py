...
def main():
    ...
    for i in range(6):
        ...
        for e in range(10):
            save_folder = 'results of reviewer/PINN/XJTU results/' + str(i) + '-' + str(i) + '/Experiment' + str(e + 1)
...
def get_args():
    ...
    parser.add_argument('--save_folder', type=str, default='results of reviewer/PINN/XJTU results', help='save folder')
